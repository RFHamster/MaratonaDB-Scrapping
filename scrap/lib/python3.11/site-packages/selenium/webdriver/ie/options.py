...
class Options(ArgOptions):
    ...
    element_scroll_behavior = _IeOptionsDescriptor(
        ELEMENT_SCROLL_BEHAVIOR, Enum
    )
    ...
    file_upload_dialog_timeout = _IeOptionsDescriptor(
        FILE_UPLOAD_DIALOG_TIMEOUT, int
    )
    ...
    force_create_process_api = _IeOptionsDescriptor(
        FORCE_CREATE_PROCESS_API, bool
    )
    ...
    force_shell_windows_api = _IeOptionsDescriptor(
        FORCE_SHELL_WINDOWS_API, bool
    )
