...
class Service(ABC):
        ...
        **kwargs,
        ...
        if isinstance(log_output, str):
            self.log_output = cast(
                IOBase, open(log_output, 'a+', encoding='utf-8')
            )
        elif log_output == subprocess.STDOUT:
            self.log_output = cast(
                typing.Optional[typing.Union[int, IOBase]], None
            )
        ...
        while True:
            ...
            if count == 70:
                raise WebDriverException(
                    f'Can not connect to the Service {self._path}'
                )
    ...
    def _start_process(self, path: str) -> None:
        ...
        close_file_descriptors = self.popen_kw.pop(
