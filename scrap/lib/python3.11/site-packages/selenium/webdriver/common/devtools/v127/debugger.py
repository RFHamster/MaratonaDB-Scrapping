...
class Paused:
    ...
    def from_json(cls, json: T_JSON_DICT) -> Paused:
        return cls(
            ...
            async_stack_trace=runtime.StackTrace.from_json(
                json['asyncStackTrace']
            )
            if 'asyncStackTrace' in json
            else None,
...
class ScriptFailedToParse:
    ...
    def from_json(cls, json: T_JSON_DICT) -> ScriptFailedToParse:
        return cls(
            ...
            if 'codeOffset' in json
            else None,
            script_language=debugger.ScriptLanguage.from_json(
                json['scriptLanguage']
            )
            if 'scriptLanguage' in json
            else None,
            embedder_name=str(json['embedderName'])
            if 'embedderName' in json
            else None,
        )
