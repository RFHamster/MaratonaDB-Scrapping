...
class UserAgentMetadata:
    ...
    full_version_list: typing.Optional[
        typing.List[UserAgentBrandVersion]
    ] = None
...
def reset_page_scale_factor() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, None
]:
    """
...
def clear_device_posture_override() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, None
]:
    """
