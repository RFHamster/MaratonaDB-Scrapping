...
class FrameResource:
    ...
    def from_json(cls, json):
        return cls(
            ...
            mime_type=str(json['mimeType']),
            last_modified=network.TimeSinceEpoch.from_json(
                json['lastModified']
            )
            if 'lastModified' in json
            else None,
            content_size=float(json['contentSize'])
            if 'contentSize' in json
            else None,
...
class WebAppManifest:
    ...
    related_applications: typing.Optional[
        typing.List[RelatedApplication]
    ] = None
...
class BackForwardCacheNotRestoredExplanation:
    ...
    details: typing.Optional[
        typing.List[BackForwardCacheBlockingDetails]
    ] = None
...
def clear_device_metrics_override() -> typing.Generator[
...
def clear_geolocation_override() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, None
]:
    """
...
def reset_navigation_history() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, None
]:
    """
...
def clear_compilation_cache() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, None
]:
    """
