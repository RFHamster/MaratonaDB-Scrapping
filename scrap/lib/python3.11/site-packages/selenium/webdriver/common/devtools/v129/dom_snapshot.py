...
class DOMNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            shadow_root_type=dom.ShadowRootType.from_json(
                json['shadowRootType']
            )
...
class LayoutTreeNode:
    ...
    def from_json(cls, json):
        return cls(
            ...
            if 'styleIndex' in json
            else None,
            paint_order=int(json['paintOrder'])
            if 'paintOrder' in json
            else None,
...
class NodeTreeSnapshot:
    ...
    def from_json(cls, json):
        return cls(
            ...
            pseudo_identifier=RareStringData.from_json(
                json['pseudoIdentifier']
            )
            ...
            current_source_url=RareStringData.from_json(
