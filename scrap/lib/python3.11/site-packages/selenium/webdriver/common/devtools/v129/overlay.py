...
class GridHighlightConfig:
    ...
    def from_json(cls, json):
        return cls(
            ...
            grid_background_color=dom.RGBA.from_json(
...
class FlexContainerHighlightConfig:
    ...
    def from_json(cls, json):
        return cls(
            ...
            main_distributed_space=BoxStyle.from_json(
                json['mainDistributedSpace']
            )
            if 'mainDistributedSpace' in json
            else None,
            cross_distributed_space=BoxStyle.from_json(
...
class HighlightConfig:
    ...
    def from_json(cls, json):
        return cls(
            ...
            if 'showStyles' in json
            else None,
            show_rulers=bool(json['showRulers'])
            if 'showRulers' in json
            else None,
            ...
            contrast_algorithm=ContrastAlgorithm.from_json(
                json['contrastAlgorithm']
            )
