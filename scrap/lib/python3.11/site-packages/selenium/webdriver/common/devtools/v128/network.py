...
class ResourceTiming:
    ...
    def from_json(cls, json):
        return cls(
            ...
            worker_router_evaluation_start=float(
...
class Request:
    ...
    def from_json(cls, json):
        return cls(
            ...
            trust_token_params=TrustTokenParams.from_json(
                json['trustTokenParams']
            )
            if 'trustTokenParams' in json
            else None,
            is_same_site=bool(json['isSameSite'])
            if 'isSameSite' in json
            else None,
        )
...
class CookieParam:
    ...
    def from_json(cls, json):
        return cls(
            ...
            same_party=bool(json['sameParty'])
            if 'sameParty' in json
            else None,
            source_scheme=CookieSourceScheme.from_json(json['sourceScheme'])
            if 'sourceScheme' in json
            else None,
            source_port=int(json['sourcePort'])
            if 'sourcePort' in json
            else None,
            partition_key=CookiePartitionKey.from_json(json['partitionKey'])
            if 'partitionKey' in json
            else None,
...
class RequestPattern:
    ...
    def from_json(cls, json):
        return cls(
            ...
            if 'urlPattern' in json
            else None,
            resource_type=ResourceType.from_json(json['resourceType'])
            if 'resourceType' in json
            else None,
            interception_stage=InterceptionStage.from_json(
                json['interceptionStage']
            )
...
def clear_browser_cookies() -> typing.Generator[
    T_JSON_DICT, T_JSON_DICT, None
]:
    """
...
class LoadingFailed:
    ...
    def from_json(cls, json: T_JSON_DICT) -> LoadingFailed:
        return cls(
            ...
            cors_error_status=CorsErrorStatus.from_json(
    ...
    **EXPERIMENTAL**
    ...
    def from_json(cls, json: T_JSON_DICT) -> RequestIntercepted:
        return cls(
            ...
            response_error_reason=ErrorReason.from_json(
