...
def visibility_of_all_elements_located(
    ...
    [WebDriverOrWebElement], Union[List[WebElement], Literal[False]]
]:
...
def element_to_be_clickable(
    ...
    def _predicate(driver: WebDriverOrWebElement):
        ...
        if not isinstance(
            target, WebElement
        ):  # if given locator instead of WebElement
...
def element_attribute_to_include(
    ...
    def _predicate(driver: WebDriverOrWebElement):
        try:
            element_attribute = driver.find_element(*locator).get_attribute(
                attribute_
            )
