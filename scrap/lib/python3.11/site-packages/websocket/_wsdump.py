...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        '-p', '--proxy', help='proxy url. ex. http://127.0.0.1:8080'
    )
    parser.add_argument(
        '-v',
        '--verbose',
    ...
    parser.add_argument(
        '-s', '--subprotocols', nargs='*', help='Set subprotocols'
    )
    ...
    parser.add_argument(
        '--headers', help="Set custom headers. Use ',' as separator"
    )
