...
class IsNoProxyHostTest(unittest.TestCase):
    ...
    def test_match_all(self):
        ...
        self.assertTrue(
            _is_no_proxy_host(
                'any.websocket.org', ['other.websocket.org', '*']
            )
        )
        os.environ['no_proxy'] = '*'
    ...
    def test_ip_address(self):
        ...
        self.assertTrue(
            _is_no_proxy_host(
                '127.0.0.1', ['other.websocket.org', '127.0.0.1']
            )
        )
        self.assertFalse(
            _is_no_proxy_host(
                '127.0.0.2', ['other.websocket.org', '127.0.0.1']
            )
        )
    ...
    def test_hostname_match(self):
        self.assertTrue(
            _is_no_proxy_host('my.websocket.org', ['my.websocket.org'])
        )
        self.assertTrue(
            _is_no_proxy_host(
        ...
        self.assertFalse(
            _is_no_proxy_host('my.websocket.org', ['other.websocket.org'])
        )
    ...
    def test_hostname_match_domain(self):
        self.assertTrue(
            _is_no_proxy_host('any.websocket.org', ['.websocket.org'])
        )
        self.assertTrue(
            _is_no_proxy_host('my.other.websocket.org', ['.websocket.org'])
        )
        self.assertTrue(
            _is_no_proxy_host(
        ...
        self.assertFalse(
            _is_no_proxy_host('any.websocket.com', ['.websocket.org'])
        )
...
class ProxyInfoTest(unittest.TestCase):
    ...
    def test_proxy_from_env(self):
        ...
        self.assertEqual(
            ...
            ('localhost2', None, None),
        )
        os.environ['http_proxy'] = 'http://localhost:3128/'
        os.environ['https_proxy'] = 'http://localhost2:3128/'
        self.assertEqual(
            get_proxy_info('echo.websocket.events', True),
            ('localhost2', 3128, None),
        )
        ...
        self.assertEqual(
            get_proxy_info('echo.websocket.events', True), (None, 0, None)
        )
        self.assertEqual(
            get_proxy_info('echo.websocket.events', False),
            ('localhost', None, None),
        ...
        os.environ[
            'no_proxy'
        ] = 'example1.com,example2.com, echo.websocket.events'
        self.assertEqual(
            get_proxy_info('echo.websocket.events', True), (None, 0, None)
        )
        os.environ['http_proxy'] = 'http://a:b@localhost:3128/'
